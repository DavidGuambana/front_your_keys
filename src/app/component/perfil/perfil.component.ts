...
onImageError() {
  ...
  encontrarid() {
    ...
    if (empleadoEncontrado) {
      ...
      this.empleado.id_empleado = empleadoEncontrado.id_empleado;  // Ahora asignamos el objeto completo
      console.error("se supone que id empleado",this.empleado.id_empleado);
    } else {
      console.error("No se encontró el empleado con la id de persona actual");
    }
  }
}
